...
Choose decision keep_open, close, or needs_human. For a high-confidence excluded feature or maintenance request with low or medium priority, choose close. For a bug, security report, unclear issue, question, uncertain classification, or any critical or high-priority feature request, choose needs_human rather than close. Never choose close when close is not allowed.
