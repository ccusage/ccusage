...
export DEVIN_TRANSCRIPTS_DIR="$HOME/.local/share/devin/cli/transcripts"
```
...
Configure Claude Code, Codex, OpenCode, Amp, Droid, Codebuff, Hermes Agent, pi-agent, Goose, OpenClaw, Kilo, Kimi, Qwen, GitHub Copilot CLI, Gemini CLI, Antigravity, Grok Build CLI, ZCode, and Devin separately with data source namespaces:
